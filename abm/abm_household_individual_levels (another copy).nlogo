...
set t_0_land_amount sum [agriculture_land] of households
 ...
 member_age > 18 AND member_relhead  > 1 ]
  ...
  set workers household_adults_non_head + 1 - migrated_hh_members - retired_hh_members
    ...
    set relative_utility agriculture_land / (hh_members + 1)
...
to export_world_procedure
  ...
  ;export-world (word simulation_run_number "run" ticks "with_tick.csv")
...
to individuals_demographics_module
  ...
  if member_sex = 1 AND member_age > 18 AND member_age < 40 AND member_migrated = FALSE [
...
<experiments>
  ...
  <experiment name="experiment" repetitions="15" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="deforestation_per_step_worker_ha" first="0.01" step="0.01" last="0.1"/>
    <steppedValueSet variable="scaling_param_migration" first="0.8" step="0.1" last="1.6"/>
    <enumeratedValueSet variable="internal_validation_mode">
      <value value="&quot;off&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="re_distribution_factor">
  ...
  <experiment name="experiment_2" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>((sum [agriculture_land] of households) - t_0_land_amount ) / t_0_land_amount</metric>
    ...
    <steppedValueSet variable="deforestation_per_step_worker_ha" first="0.01" step="0.01" last="0.2"/>
    <steppedValueSet variable="scaling_param_migration" first="0.6" step="0.1" last="2"/>
    <enumeratedValueSet variable="internal_validation_mode">
      <value value="&quot;off&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="re_distribution_factor">
  ...
  <experiment name="inequality_effects" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>((sum [agriculture_land] of households) - t_0_land_amount ) / t_0_land_amount</metric>
    <metric>gini-index-reserve</metric>
    ...
    <steppedValueSet variable="desired_gini_level" first="5" step="5" last="40"/>
    <enumeratedValueSet variable="probability_remittances_agriculture_invest">
      <value value="0.05"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="remittances_usage_scaling_param">
